...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_recipe_other_users_recipe_error(self):
        """"Test trying tp delete another users  recipe gives error."""
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title='Panner butter masala curry')
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='Polish beans on toast')
